...
--   1. The admin page route checks isAdmin() which only allows zander@got1.app
...
-- 3. ADMIN_EMAILS can contain your email as a fallback (zander@got1.app)
...
-- 6. Only your account (zander@got1.app) should have admin access
