...
/**
 * Error boundary component for the browse route.
 * Catches errors that occur when loading the browse page.
 */
    ...
    <div className="min-h-screen bg-white flex items-center justify-center">
      <div className="text-center max-w-md mx-4">
        ...
        <p className="text-gray-600 mb-6">
          {error.message || 'An error occurred while loading the browse page.'}
        </p>
        <button
          onClick={reset}
