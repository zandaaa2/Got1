...
import PurchaseConfirmationContent from '@/components/evaluations/PurchaseConfirmationContent'
...
export default async function PurchaseConfirmationPage({
  ...
  if (!evaluation || evaluation.player_id !== session.user.id) {
    redirect('/my-evals')
  }
  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <DynamicLayout header={headerContent}>
        <PurchaseConfirmationContent evaluation={evaluation} sessionId={searchParams.session_id} />
      </DynamicLayout>
    </div>
  )
}
