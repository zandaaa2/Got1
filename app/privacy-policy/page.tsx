...
const SECTION_HEADING = 'text-2xl font-normal text-black mb-4'
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-12 pb-12">
        <div className="max-w-4xl mx-auto px-8 sm:px-12 lg:px-16">
          <h1 className="text-2xl md:text-3xl font-normal text-black mb-4 md:mb-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-10">
              ...
              <h3 className="text-xl font-normal text-black mb-2">A. Information You Provide</h3>
              <ul className={LIST}>
                <li>
              ...
              <h3 className="text-xl font-normal text-black mb-2">B. Information Collected Automatically</h3>
              <ul className={LIST}>
              ...
              <h3 className="text-xl font-normal text-black mb-2">C. Information from Third Parties</h3>
              <ul className={LIST}>
