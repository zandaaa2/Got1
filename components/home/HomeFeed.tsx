...
export default function HomeFeed() {
  ...
  return (
    <div className="max-w-2xl mx-auto w-full">
      ...
      {/* Mobile Post Button - Fixed at bottom */}
      <button
        onClick={() => setShowPostModal(true)}
        className="fixed bottom-24 left-1/2 transform -translate-x-1/2 z-30 md:hidden px-6 py-3 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-colors font-medium text-sm flex items-center gap-2"
      >
