...
export default function PurchaseEvaluation({
  ...
  return (
    <div className="max-w-2xl mx-auto">
      {/* Evaluation Offers - Responsive Grid when free eval enabled */}
      {scout.free_eval_enabled && scout.free_eval_description ? (
        <div className="grid grid-cols-2 md:grid-cols-1 gap-4 mb-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <button
              onClick={handleRequestFreeEval}
              disabled={processing}
              className="w-full px-6 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 disabled:opacity-50 font-semibold text-sm md:text-base transition-colors disabled:active:scale-100"
            >
              {processing ? 'Processing...' : 'Request Free Evaluation'}
            </button>
          </div>
