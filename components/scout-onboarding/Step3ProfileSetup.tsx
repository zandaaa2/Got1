...
export default function Step3ProfileSetup({ session, profile, onComplete, onBack }: Step3ProfileSetupProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create or update profile with role='user' (will become scout after application approval)
    ...
    <>
      {showSuccessAnimation && !showLoading && (
        <AccountCreatedAnimation 
          ...
          message="Redirecting to finish your scout application..."
        />
      )}
      {showLoading && (
        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              We need some basic information to set up your account. This will be used for your scout profile.
            </p>
          </div>
