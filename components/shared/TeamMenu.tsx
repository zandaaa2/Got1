...
export default function TeamMenu({ teamSlug, teamName, isSignedIn }: TeamMenuProps) {
  ...
  const handleSubmitReport = async () => {
    try {
      ...
      // Send email report for team
      const response = await fetch('/api/report/team', {
        method: 'POST',
        ...
        {reportSuccess ? (
          <div className="space-y-4">
            <p className="text-black leading-relaxed">
              Thanks for letting us know. Our team will review this team page and take the appropriate action.
            </p>
            <button
              onClick={() => {
                setShowReportModal(false)
          ...
          <div className="space-y-4">
            <p className="text-black leading-relaxed">
              You are reporting <strong>{teamName}</strong>. This sends a message to the Got1 team to review this team page.
            </p>
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Share any details that can help our team review this team page..."
