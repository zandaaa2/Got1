...
-- Only the author (zander@got1.app) can insert/update/delete
CREATE POLICY "Author can manage blog posts" ON blog_posts
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM auth.users
      WHERE auth.users.id = auth.uid()
      AND auth.users.email = 'zander@got1.app'
    )
  );

-- Insert initial blog posts
INSERT INTO blog_posts (slug, title, excerpt, content, image, author, author_email, published_at) VALUES
('recruiting-trends-2026', 'Top Recruiting Trends for 2026', 'Discover the latest trends shaping college football recruiting and how to position yourself for success in the evolving landscape.', '# Top Recruiting Trends for 2026
...
Start building your recruiting profile today and get the professional feedback you need to advance your football career.', '/landingpage/herohorizontal.jpg', 'Zander Huff', 'zander@got1.app', '2026-01-15T10:00:00Z'),
('how-scouts-evaluate-qbs', 'How Scouts Evaluate QBs', 'Learn what college scouts are looking for when evaluating quarterback prospects and how to showcase your skills effectively.', '# How Scouts Evaluate QBs
...
Ready to get professional QB evaluation? Submit your film to verified college scouts on Got1 and receive detailed feedback on your game.', '/landingpage/herohorizontal.jpg', 'Zander Huff', 'zander@got1.app', '2026-01-10T10:00:00Z'),
('success-stories', 'Success Stories from Got1 Athletes', 'Read inspiring stories from athletes who used Got1 evaluations to advance their recruiting and achieve their college football dreams.', '# Success Stories from Got1 Athletes
...
Ready to advance your recruiting journey? Submit your film today and get professional evaluations from verified college scouts.', '/landingpage/herohorizontal.jpg', 'Zander Huff', 'zander@got1.app', '2026-01-05T10:00:00Z'),
('recruiting-timeline', 'Understanding the Recruiting Timeline', 'A comprehensive guide to the college football recruiting timeline and when to take key actions throughout your high school career.', '# Understanding the Recruiting Timeline
...
Ready to get started? Submit your film for professional evaluation today.', '/landingpage/herohorizontal.jpg', 'Zander Huff', 'zander@got1.app', '2025-12-20T10:00:00Z'),
('game-film-best-practices', 'Game Film Best Practices', 'Expert tips on creating compelling game film that captures scouts'' attention and effectively showcases your abilities on the field.', '# Game Film Best Practices
...
Ready to get professional feedback on your game film? Submit it to verified college scouts on Got1 today.', '/landingpage/herohorizontal.jpg', 'Zander Huff', 'zander@got1.app', '2025-12-15T10:00:00Z')
